...
Write website copy for this dealer. Use their voice and the details they provided. Keep it professional but approachable — this is a local equipment dealer, not a corporate chain.

Return ONLY a valid JSON object with these exact keys, no markdown, no backticks, no extra text:
{
  "hero.heading": "Main homepage headline (6-10 words, punchy)",
  "hero.subheading": "Homepage subheadline (1-2 sentences, what they do and who they serve)",
  "hero.ctaButton.text": "Primary CTA button text (2-4 words)",
  "cta.heading": "Bottom-of-page CTA heading (5-8 words)",
  "cta.subheading": "Bottom CTA supporting text (1 sentence)",
  "cta.primaryButton.text": "CTA primary button (2-4 words)",
  "manufacturers.heading": "Section heading for brands carousel (3-5 words)",
  "manufacturers.subheading": "Brief brands section subheading (1 sentence)",
  "footer.tagline": "Short footer tagline (5-8 words)"${addons.includes('inventory') ? `,
  "inventoryPage.heading": "Inventory page heading (3-5 words)",
  "inventoryPage.subheading": "Inventory page subheading (1 sentence)"` : ''}${addons.includes('service') ? `,
  "servicePage.heading": "Service page heading (3-5 words)",
  "servicePage.subheading": "Service page subheading (1 sentence)",
  "servicePage.whyChooseHeading": "Why choose our service heading (3-6 words)",
  ...
  "servicePage.why3Description": "Third benefit description (1 sentence)"` : ''}${addons.includes('rentals') ? `,
  "rentalsPage.heading": "Rentals page heading (3-5 words)",
  "rentalsPage.subheading": "Rentals page subheading (1 sentence)",
  "rentalsPage.ctaHeading": "Rental CTA heading (4-6 words)",
  "rentalsPage.ctaText": "Rental CTA supporting text (1 sentence)"` : ''}
}`;
