          ...
          <tr>
            <td style="background:#ffffff;padding:40px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:16px;">
                <tr>
                  ...
                  <td style="padding-left:12px;">
                    <p style="margin:0 0 2px;font-size:15px;font-weight:700;color:#0f172a;">March 30 — Dashboard Access Email</p>
                      ...
                      <tr>
                        ...
                        <td style="padding-left:12px;">
                          ...
                          <p style="margin:0;font-size:14px;color:#3b82f6;line-height:1.5;">
                            <strong>March 30</strong> — Dashboard access &amp; add-on selection<br>
                            <strong>March 30</strong> — All beta sites go live<br>
              ...
              <p style="margin:0;font-size:15px;color:#64748b;text-align:center;line-height:1.6;">
                We're excited to have you on board. Keep an eye on your inbox — your dashboard access is coming March 30!
              </p>
            </td>
          </tr>
