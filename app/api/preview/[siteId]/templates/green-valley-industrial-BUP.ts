...
export async function renderGreenValleyPage(
  ...
  return gvHtmlShell(colors, fonts, siteName, googleFontsUrl)
    ...
    + body
    + footer
    + (enabledFeatures && enabledFeatures.has('rental_scheduling') ? rentalModalBlock('gv', siteId) : '')
      ...
      <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div class="max-w-3xl">
          ...
          <div class="flex flex-wrap gap-4">
            <a href="${getContent('hero.ctaButton.destination') ? (getContent('hero.ctaButton.destination') === '__custom' ? getContent('hero.ctaButton.destination_url') : `${baseUrl}${getContent('hero.ctaButton.destination')}`) : (getContent('hero.ctaLink') ? `${baseUrl}${getContent('hero.ctaLink')}` : `${baseUrl}inventory`)}"
              class="cta-button rounded-md">
              ${getContent('hero.ctaButton.text') || getContent('hero.ctaButton') || 'View Inventory'}
            </a>
            ${(getContent('hero.secondaryButton.text') || getContent('hero.secondaryButton') || getContent('hero.secondaryLink')) ? `
            <a href="${getContent('hero.secondaryButton.destination') ? (getContent('hero.secondaryButton.destination') === '__custom' ? getContent('hero.secondaryButton.destination_url') : `${baseUrl}${getContent('hero.secondaryButton.destination')}`) : `${baseUrl}${getContent('hero.secondaryLink') || 'contact'}`}"
    ...
    <section data-section="cta" class="py-16 md:py-24 bg-secondary">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
          <a href="${getContent('cta.primaryButton.destination') ? (getContent('cta.primaryButton.destination') === '__custom' ? getContent('cta.primaryButton.destination_url') : `${baseUrl}${getContent('cta.primaryButton.destination')}`) : (getContent('cta.primaryLink') ? `${baseUrl}${getContent('cta.primaryLink')}` : `${baseUrl}inventory`)}"
          ...
          <a href="${getContent('cta.secondaryButton.destination') ? (getContent('cta.secondaryButton.destination') === '__custom' ? getContent('cta.secondaryButton.destination_url') : `${baseUrl}${getContent('cta.secondaryButton.destination')}`) : (getContent('cta.secondaryLink') ? `${baseUrl}${getContent('cta.secondaryLink')}` : `${baseUrl}contact`)}"
          ...
          <div class="industrial-card group overflow-hidden rounded-lg">
            ...
            <div class="p-4">
              ...
              ${item.quantity_available > 0
                ? rentalReserveButton(item, 'gv', 'block w-full text-center cta-button rounded-md text-sm py-2 cursor-pointer border-0 w-full')
