...
import {
  ...
  Mail, MessageSquare, Loader2, ExternalLink, TrendingUp, Users,
  Eye, Activity, Lock, User, Building2
} from 'lucide-react';
...
function DashboardPage() {
  ...
  // Reload notification counts every time user lands on /dashboard
  useEffect(() => {
  ...
  const quickActions = [
    ...
    { title: 'Manufacturers', description: 'Manage brand logos',       icon: Building2,   href: '/dashboard/manufacturers',color: 'bg-purple-500',  addon: null,        notify: false },
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={`https://${site.slug}.fleetmarket.us`} target="_blank" rel="noopener noreferrer"
