...
import { ShoppingCart, MessageSquare, ExternalLink, CheckCircle, Loader2, AlertCircle } from 'lucide-react';
...
export default function CheckoutSettings({ siteId, initialMode, stripeAccountId }: CheckoutSettingsProps) {
