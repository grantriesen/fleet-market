...
export const TEMPLATE_PROMPTS: Record<string, TemplatePromptConfig> = {
  ...
  'warm-earth-designs': {
    ...
    alwaysFields: {
      // Hero
      'hero.heading': 'Hero heading (5-9 words, warm and grounded, connected to land or community)',
      'hero.subheading': 'Hero subheading (1-2 sentences, personal and community-focused)',
      'hero.statValue': 'A meaningful stat like years in business (e.g. 30+)',
      'hero.statLabel': 'Stat label (2-4 words, e.g. Years Serving Our Community)',
      // Value Props
      'valueProps.valueProp1.text': 'Value prop 1 title (2-4 words, e.g. Quality Equipment)',
      'valueProps.valueProp1.description': 'Value prop 1 description (1 warm sentence)',
      'valueProps.valueProp2.text': 'Value prop 2 title (2-4 words, e.g. Expert Service)',
      'valueProps.valueProp2.description': 'Value prop 2 description (1 warm sentence)',
      'valueProps.valueProp3.text': 'Value prop 3 title (2-4 words, e.g. Local Trust)',
      'valueProps.valueProp3.description': 'Value prop 3 description (1 warm sentence)',
      // Featured
      'featured.heading': 'Featured section heading (2-4 words, warm)',
      'featured.subheading': 'Featured subheading (1 sentence)',
      // Manufacturers
      'manufacturers.heading': 'Brands section heading (3-5 words)',
      'manufacturers.subheading': 'Brands subheading (1 sentence about sharing values with the brands they carry)',
      // Testimonials
      'testimonials.heading': 'Testimonials heading (3-5 words, community feel, e.g. From Our Community)',
      // CTA
      'cta.heading': 'CTA heading (5-8 words, inviting, warm)',
      'cta.subheading': 'CTA subheading (1-2 sentences, warm invitation to visit)',
      // Footer
      'footer.tagline': 'Footer tagline (5-8 words, warm and grounded)',
      // Contact Page
      'contactPage.heading': 'Contact page heading (2-4 words, friendly)',
      'contactPage.subheading': 'Contact page subheading (1 short warm sentence)',
      'contactPage.contentHeading': 'Contact page content heading (3-6 words)',
      'contactPage.contentText': 'Contact page content paragraph (2-3 sentences, warm and inviting, about visiting or reaching them)',
      'contactPage.formHeading': 'Contact form heading (3-5 words)',
      'contactPage.locationHeading': 'Location section heading (3-5 words)',
      // Manufacturers Page
      'manufacturersPage.heading': 'Manufacturers page heading (3-5 words)',
      'manufacturersPage.subheading': 'Manufacturers page subheading (1-2 sentences)',
      'manufacturersPage.contentHeading': 'Manufacturers content heading (3-5 words)',
      'manufacturersPage.contentText': 'Manufacturers content paragraph (2-3 sentences about their brand selection)',
      'manufacturersPage.whyHeading': 'Why section heading (3-6 words, e.g. Why These Brands?)',
      'manufacturersPage.whyText1': 'Why paragraph 1 (2-3 sentences about brand selection philosophy and shared values)',
      'manufacturersPage.whyText2': 'Why paragraph 2 (2-3 sentences about authorized dealer benefits and parts/service)',
      'manufacturersPage.ctaHeading': 'Manufacturers CTA heading (4-6 words)',
    ...
    inventoryFields: {
      ...
      'inventoryPage.contentHeading': 'Inventory content heading (3-5 words)',
      'inventoryPage.contentText': 'Inventory content paragraph (2-3 sentences about their equipment selection or buying process)',
      'inventoryPage.filterLabel': 'Filter label (2-4 words, e.g. Browse By Type)',
    },
    serviceFields: {
      'servicePage.heading': 'Service page heading (3-5 words)',
      'servicePage.subheading': 'Service page subheading (1 sentence)',
      'servicePage.gridHeading': 'Services grid heading (3-5 words, e.g. What We Service)',
      ...
      'servicePage.service1Description': 'Service 1 description (1-2 sentences based on their services)',
      ...
      'servicePage.ctaText': 'Service CTA supporting text (1 sentence)',
    },
    rentalsFields: {
      ...
      'rentalsPage.info1.text': 'Rental info card 1 title (2-4 words, e.g. Flexible Terms)',
      'rentalsPage.info1.description': 'Rental info card 1 description (1 sentence)',
      'rentalsPage.info2.text': 'Rental info card 2 title (2-4 words, e.g. Try Before You Buy)',
      'rentalsPage.info2.description': 'Rental info card 2 description (1 sentence)',
      'rentalsPage.info3.text': 'Rental info card 3 title (2-4 words, e.g. Well-Maintained)',
      'rentalsPage.info3.description': 'Rental info card 3 description (1 sentence)',
      'rentalsPage.pricingNote': 'Pricing note (1-2 sentences about rental rates and discounts)',
    },
  },
